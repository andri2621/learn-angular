...
Add directory to node_modules/bootstrap/dist/css/bootstrap.min.css in angular.json
...
ng generate directive namedirective
//
...
@Input() decorator is to make the element properties can handled or accessed (bind) by parent element
or
@Input(‘aliasname’) to bind the properties using alias name
...
Example: <app-server> <p>Text</p> </app-server>
...
You can communicate between component using service with Event Emitter.
...
And you can subscribe in the shopping-edit component, in any other component:
